...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE `data` SET name=%s, price=%s, Image=%s WHERE id=%s",
  ...
  $updateGoTo = "del.php?" . $row_Recordset1['id'] . "=" . $row_Recordset1['id'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_mycon, $mycon);
$query_Recordset1 = "SELECT * FROM `data` WHERE `data`.id='$id'";
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="Image" value="<?php echo htmlentities($row_Recordset1['Image'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
